...
const App = () => {
  ...
  return (
    <div>
      ...
      <h1>Task Listing</h1>
      <TaskListingPage tasks={tasks} handleEdit={handleEditTask} handleDelete={handleDeleteTask} />

      {selectedTask && (
        <div>
          <h1>Task Detail</h1>
          <TaskDetail task={selectedTask} onEdit={handleUpdateTask} onDelete={handleDeleteTask} />
        </div>
      )}
    </div>
  );
